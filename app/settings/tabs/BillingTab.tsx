    ...
    <div className="space-y-8">
      ...
      <section className="bg-white rounded-lg shadow p-6 flex flex-col md:flex-row md:space-x-8">
        <div className="flex-1 mb-8 md:mb-0">
          <h2 className="text-lg text-gray-900 font-semibold mb-2">Current Plan</h2>
          <div className="mb-2 text-base text-gray-900 font-medium">Pro Plan <span className="text-gray-500 font-normal">$49/monthly</span></div>
          ...
          <div className="mb-4">
            <div className="text-sm text-gray-900 font-semibold mb-1">Plan Features</div>
          ...
          <div className="flex space-x-2">
            ...
            <button className="border border-gray-300 text-gray-900 px-4 py-2 rounded font-medium">Change Billing Cycle</button>
            <button className="border border-red-300 text-red-600 px-4 py-2 rounded font-medium">Change Subscription</button>
          </div>
        </div>
        {/* Billing History */}
        <div className="w-full md:w-72">
          <h3 className="text-base text-gray-900 font-semibold mb-2">Billing History</h3>
          <div className="space-y-2">
            {[1,2,3].map(i => (
              <div key={i} className="flex items-center justify-between bg-gray-50 rounded px-3 py-2 border">
                <div>
                  <div className="font-medium text-gray-900 text-sm">INV-001</div>
      ...
      <section className="bg-white rounded-lg shadow p-6">
        <h2 className="text-lg text-gray-900 font-semibold mb-2">Payment Method</h2>
        ...
        <div className="flex items-center justify-between bg-gray-50 border rounded p-4 mb-4">
          ...
          <button className="border text-gray-900 px-3 py-1 rounded text-sm font-medium">Edit</button>
        </div>
        <button className="border text-gray-900 px-4 py-2 rounded font-medium">Add Payment Method</button>
      </section>
    </div>
  );
};
