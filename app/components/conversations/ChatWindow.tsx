      ...
      <div className="p-3 sm:p-4 border-t border-gray-200 bg-white">
        ...
        >
          <input
            ...
            className="flex-1 px-3 sm:px-4 py-2 text-sm sm:text-base border border-gray-300 text-black rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
          ...
          <button
            type="submit"
            className="px-3 sm:px-4 py-2 text-sm sm:text-base bg-primary text-white rounded-lg hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary"
          >
            Send
          </button>
        </form>
